            ...
            <Box>
                <List  className={menu.list_menu}>
                    <ListItem sx={{width: "60px"}}>
                        <a href="https://www.google.com/" target="blank" className={menu.link}>
                    ...
                    <ListItem sx={{width: "110%", display: "flex",flexDirection: "column", padding: 0}} className={menu.menuItem}>
                        ...
                        <ListItem className={menu.afterList}>
                            <ListItemText className={menu.afterListItem} primary="Bản đồ hệ thống di tích Lịch sử trên địa bàn thành phố Hà Nội( Song ngữ Việt - Anh)" />    
                            <ListItemText className={menu.afterListItem} primary="Bản đồ hệ thống di tích lịch sử tỉnh Quảng Trị ( Song ngữ Việt - Anh) " />  
                        </ListItem>
                    </ListItem>
                    <ListItem sx={{width: "105%", display: "flex",flexDirection: "column", padding: 0}} className={menu.menuItem}>
                        ...
                        <ListItem className={menu.afterList}>
                            <ListItemText className={menu.afterListItem} primary="Chinh phục Văn Miếu Quốc Tử Giám ( Virtual museum of Quoc Tu Giam relics)" />    
                            <ListItemText className={menu.afterListItem} primary="Giải mã Hoàng Thành Thăng Long" />  
